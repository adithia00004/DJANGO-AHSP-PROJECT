...
export class GanttChart {
  ...
  _buildTasks() {
    ...
    // Build assignment buckets per pekerjaan
    const buckets = this._buildAssignmentBuckets();
    ...
    pekerjaanList.forEach((pekerjaan) => {
      ...
      // Calculate dates and progress from bucket
      ...
      // Determine task class based on progress
