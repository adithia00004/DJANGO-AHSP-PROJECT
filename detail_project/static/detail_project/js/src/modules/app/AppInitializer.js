    ...
    const domRefs = Object.assign(
      {
        ...
        saveStateIndicatorEl: document.getElementById('save-state-indicator'),
        lastSavedAtEl: document.getElementById('last-saved-at'),
        ...
        emptyStateEl: document.getElementById('jadwal-empty-state'),
