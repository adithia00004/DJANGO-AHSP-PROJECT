...
$env:REDIS_URL = "redis://:redis_password@localhost:6379/1"
$env:CELERY_BROKER_URL = "redis://:redis_password@localhost:6379/0"
$env:CELERY_RESULT_BACKEND = "redis://:redis_password@localhost:6379/0"

Write-Host "Forcing Local Connection: POSTGRES_HOST=localhost"
