...
class TestConcurrentEditScenarios:
    ...
    def test_two_users_edit_different_items(self, client_logged, project, setup_harga_items_test):
        """
        Test concurrent saves editing different items (simulated with same user).
        ...
        # Both saves should succeed (different items, row-level locks don't conflict)
